...
(* \:8fd8\:9700\:5f53expr\:4e0d\:662f \[OpenCurlyDoubleQuote]\:4e58\[CloseCurlyDoubleQuote]\:5f00\:5934\:7684\:60c5\:51b5\:3002 *)
...
FenPei[expr_Plus,subl_List,hang_Integer]:=Module[{i},
For[i=1,i<=Length[expr],i++,
FenPei[expr[[i]],subl,hang];
]
]
FenPei[expr_,subl_List,hang_Integer]:=Module[{j,g,h,l,subr,sr,dd,cont,subll,dest},
(* \:5047\:5b9a\:5927\:77e9\:9635M\:662f\:5168\:5c40\:53d8\:91cf\:3002subl\:662f\:5de6\:8fb9\:683c\:6797\:51fd\:6570\:7684\:4e0b\:6807\:ff1bhang\:662f\:5de6\:8fb9\:683c\:6797\:51fd\:6570\:7684\:884c\:503c\:3002 *)
...
Cheng[m1_List,m2_List]:= Module[{tmp},(* \:4e58\:6cd5\:8fd0\:7b97 *)
Which[
m2[[1]]==="I",
tmp=m1
,
...
{"c",m1[[2]],m2[[3]],Flatten[Table[ChengLL[m1[[4,i]],m2[[4,j]]],{i,Length[m1[[4]]]},{j,Length[m2[[4]] ] }],1]   }
  

Yu6[y_List,s_List]:=Module[{i,xy=y,xs=s,t}, (* he Yu5 yi yang, zhi shi xiang fan *)
...
Yu5[y_List,e_List]:=Module[{i,xy=y,xe=e,t}, (* see manuscript *)
For[i=1,i<=Length[xy],i++,
...
Lian[e_List,s_List]:=Module[ {i,t,xe=e,xs=s,k={}},
...
YiYangY[l_List]:=Module[{i,tmp,ret={} ,p},
(* \:8fd4\:56de\:4e00\:6837\:7684\:4e1c\:897f\:7684\:5217\:8868\:ff0c\:4ee5\:53ca\:5bf9\:5e94\:7684\:4f4d\:7f6e *)
For[i=1,i<=Length[l]-1,i++,
...
HeBingX[l_List,yy_List,dimen_]:=Module[{ret={},i,j,s},
(* s \:662f\:65e0\:6cd5\:5316\:7b80\:7684\:9879 *)
...
Which[
dimen==1,
AppendTo[ret,{  yy[[i,1]],{   {Plus@@(Apply[Times,l[[yy  [[i,2]] ,2,1]],{1} ]l[[yy  [[i,2]] ,3,1]])},l[[  yy[[i,2,1]],2,2]] },{1,l[[ yy[[i,2,1]],3,2]]} }]
(* this proc fails if subs' length exceeds one *)
,
dimen==0,
AppendTo[ret,{ yy[[i,1]], {   {},{} },{Plus@@(Apply[Times,l[[yy  [[i,2]] ,2,1]],{1} ]l[[yy  [[i,2]] ,3,1]]),l[[ yy[[i,2,1]],3,2]]} }]
];
];
{ret[[-1,2,1]],ret[[-1,3,1]]}= Fen[ ret[[-1,2,1]] ,ret[[-1,3,1]],y  ];
ret
]
HeBingY[l_List,yy_List,dimen_]:=Module[{ret={},i,j,s},
(* s \:662f\:65e0\:6cd5\:5316\:7b80\:7684\:9879 *)
s=Complement[Range[Length[l] ], Flatten[  yy[[All,2]]  ]   ];
For[i=1,i<=Length[s],i++,
AppendTo[ret,l[[ s[[i]]  ]] ];
...
For[i=1,i<=Length[yy],i++,
Which[
dimen==1,AppendTo[ret,{  {   {Plus@@(Apply[Times,l[[yy  [[i,2]] ,1,1]],{1} ]l[[yy  [[i,2]] ,3,1]])},l[[  yy[[i,2,1]],1,2]] },yy[[i,1]],{1,l[[ yy[[i,2,1]],3,2]]} }];
(* this proc fails if subs' length exceeds one *)
,
dimen==0,
AppendTo[ret,{  {   {},{} },yy[[i,1]],{Plus@@(Apply[Times,l[[yy  [[i,2]] ,1,1]],{1} ]l[[yy  [[i,2]] ,3,1]]),l[[ yy[[i,2,1]],3,2]]} }]
];
];
{ret[[-1,1,1]],ret[[-1,3,1]]}= Fen[ ret[[-1,1,1]],ret[[-1,3,1]] ,x  ];
ret
]
Fen[lb_List,onum_,v_]:=Module[{i,l=lb,num=onum,t},
...
HuaJian[l_List,dx_,dy_]:=Module[ {t,ret=l},
...
(* \:8fd8\:9700\:8981\:67e5delta\:51fd\:6570\:3002 *)
ret
]
QingKuang[m_]:=Module[{d=0,f=0,i},
(* m[[4]] *)
If[m[[2]]==0,
1(* 1\:3001\:8fd9\:4e2a\:77e9\:9635\:53ea\:662f\:4e00\:4e2a\:6570\:ff1b *)
,
For[i=1,i<=Length[m[[4]]  ],i++,
If[ m[[4,i,3,2]]==={},
f++,
...
Which[d==0&&f==1,
2(* 2\:3001\:6ca1\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e00\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b *)
,
d>0&&f==0,
3(* 3\:3001\:53ea\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:6ca1\:6709\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b *)
,
d>0&&f==1,
4(* 4\:3001\:65e2\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e5f\:6709\:4e00\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b *)
,
d==0&&f>1,
5(* 5\:3001\:6ca1\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4f46\:6709\:591a\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:3002*)
,
d>0&&f>1,
6 (* 6\:3001\:6709\:4e00\:4e2a\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e5f\:6709\:591a\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:3002*)
]
]
]
Ni[II]:=II
Ni[m_List]:=Module[{ret,t1,t2},
(* Print["inverting:",m]; *)
If[!KeNi[m],
...
(* 
\:5bf9\:5c06\:8981\:53d6\:9006\:7684\:77e9\:9635mat\:ff0c\:5206\:4ee5\:4e0b\:51e0\:79cd\:60c5\:51b5\:ff1a
1\:3001\:8fd9\:4e2a\:77e9\:9635\:53ea\:662f\:4e00\:4e2a\:6570\:ff1b
2\:3001\:6ca1\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e00\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b
3\:3001\:53ea\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:6ca1\:6709\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b
4\:3001\:65e2\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e5f\:6709\:4e00\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b
5\:3001\:6ca1\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4f46\:6709\:591a\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:3002
6\:3001\:6709\:4e00\:4e2a\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e5f\:6709\:591a\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:3002 \:ff08\:5c1a\:672a\:9047\:5230\:540e\:4e24\:79cd\:60c5\:51b5\:ff0c\:5982\:679c\:5206\:79bb\:53d8\:91cf\:90e8\:5206\:53ef\:4ee5\:7ee7\:7eed\:56e0\:5f0f\:5206\:89e3\:ff0c\:5219\:5e94\:7ee7\:7eed\:5206\:89e3\:ff0c\:5426\:5219\:7b97\:6cd5\:5931\:6548\:3002\:ff09
*)
Switch[QingKuang[m],
1,
(* 1\:3001\:8fd9\:4e2a\:77e9\:9635\:53ea\:662f\:4e00\:4e2a\:6570\:ff1b *)
...
(* 2\:3001\:6ca1\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e00\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b *)
ret=m;
ret[[4,1,3,1]]*=-1/(1+ret[[4,1,3,1]]SuoBing[Times@@ret[[4,1,1,1]],Times@@ret[[4,1,2,1]] ])
,
3,
(* 3\:3001\:53ea\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:6ca1\:6709\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b *)
(* \:5982\:679c\:6df1\:5ea6\:5927\:4e8e1\:5c31\:7cdf\:4e86\:3002 *)
If[m[[2]]>1||Length[m[[4]]]>1,Print["zao le"];
Print[m];
...
4,
(* 4\:3001\:65e2\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e5f\:6709\:4e00\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:ff1b *)
(* \:82e5A\:4e3a\:4e00\:4e2a\:5bf9\:89d2\:9635\:ff0c\:5219 (I+A+B)^-1=(I+(I+A)^-1B)^-1(I+A)^-1\:3002
\:7a0b\:5e8f\:4e2d\:ff0c=(I+A)^-1\:ff1b =B\:3002
*)
t1=Ni[{m[[1]],m[[2]],m[[3]],Select[m[[4]],#[[3,2]]=!={}&]   }];
(* Print["yi ni:",t1]; *)
(* Print["multi:",{"c",m[[2]],m[[3]],Select[m[[4]],#[[3,2]]==={}&]   }]; *)
t2=Cheng[t1,{"c",m[[2]],m[[3]],Select[m[[4]],#[[3,2]]==={}&]   }];
t2[[1]]="Ic";  (* \:56e0\:4e3a\:524d\:9762\:52a0\:4e86\:4e00\:4e2aI *)
(* Print["t2:",t2]; *)
ret=Cheng[ Ni[t2]  ,t1];
,
5,
(* 5\:3001\:6ca1\:6709\:5bf9\:89d2\:90e8\:5206\:ff0c\:4f46\:6709\:591a\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:3002
\:ff08\:5c1a\:672a\:9047\:5230\:6b64\:60c5\:51b5\:ff0c\:5982\:679c\:5206\:79bb\:53d8\:91cf\:90e8\:5206\:53ef\:4ee5\:7ee7\:7eed\:56e0\:5f0f\:5206\:89e3\:ff0c\:5219\:5e94\:7ee7\:7eed\:5206\:89e3\:ff0c\:5426\:5219\:7b97\:6cd5\:5931\:6548\:3002\:ff09
*)
Print[5];
Print[m];Abort[]
,
6,
(* 6\:3001\:6709\:4e00\:4e2a\:5bf9\:89d2\:90e8\:5206\:ff0c\:4e5f\:6709\:591a\:4e2a\:5206\:79bb\:53d8\:91cf\:7684\:90e8\:5206\:3002 \:ff08\:5c1a\:672a\:9047\:5230\:6b64\:60c5\:51b5\:ff0c\:5982\:679c\:5206\:79bb\:53d8\:91cf\:90e8\:5206\:53ef\:4ee5\:7ee7\:7eed\:56e0\:5f0f\:5206\:89e3\:ff0c\:5219\:5e94\:7ee7\:7eed\:5206\:89e3\:ff0c\:5426\:5219\:7b97\:6cd5\:5931\:6548\:3002\:ff09
*)
Print[6];Print[m];
Abort[]
];
...
Print[p];
		For[h=p-1,h>0,h--,
			If[M[[h,p]]===Ling,Continue[] ];
If[p==70,Print[ "h: ",h];];
If[p==70&&h==67,Print["L1:",L[[1]]];Print["M:",M[[h,p]] ]; ];
			L[[2]]=Cheng[M[[h,p]],L[[1]]   ];
...
kaca[GFind_Integer,pathway_List,multiplier_,replist_]:=Module[{i,j,curreom,gfidx,gfform,recent,lhs,baksum},
...
(*	Print["   kaca : ",GFind,"  ",lhs," == ",curreom,"  ",pathway,"    "]; *)
	Switch[curreom,
		_Plus,
			curreom=List@@curreom;  (* \:5fc5\:987b\:6362\:6210\:5217\:8868\:ff0c\:4e0d\:7136\:505a\:8fc7\:8ba1\:7b97\:4ee5\:540e\:6709\:53ef\:80fd\:9879\:4e0e\:9879\:4e4b\:95f4\:7684\:987a\:5e8f\:53ef\:80fd \:ff08\:80af\:5b9a\:ff09\:4f1a\:53d8\:ff01\:7b2c\:4e8c\:6b21\:72af\:8fd9\:79cd\:50bb\:4e86\:ff01\:ff01 *)
			(*Print[GFind,"  ",curreom];*)
...
(* Print["----- term ",i, " of ",GFind,"  ",curreom[[i]]];*)
				...
				curreom[[i]]=grasp[lhs,recent,curreom[[i]] ];   (* \:8fd8\:6ca1\:505a\:4e0b\:6807\:4ee3\:6362\:ff0c\:8981\:505a\:3002 *)
(*				Print["grasped into: ",curreom[[i]]," lhs: ", lhs];*)
				gfidx=GFIiT[curreom[[i]] ];
				gfform=GFiT[curreom[[i]] ];
				If[Length[gfform]>1,Print["Error: multiple of GF's found in term ",curreom[[i]]  ];Abort[]; ];
				If[gfidx>0,
...
(*						Print["passing ",i," of ",GFind,"  ",MiT[curreom[[i]] ],"   ",multiplier];*)
							curreom[[i]]=curreom[[i]]/MiT[curreom[[i]] ]/gfform *
								kaca[gfidx,pathway~Join~{GFind},MiT[curreom[[i]] ] , 
...
Print["path: ",pathway,"  idx: ",gfidx]; *)
				...
				If[Head[curreom[[i]]]===Plus,
					...
					For[j=1,j<=Length[curreom[[i]] ],j++,
						...
						curreom[[i,j]]=grasp[lhs,recent,curreom[[i,j]] ];   (* \:8fd8\:6ca1\:505a\:4e0b\:6807\:4ee3\:6362\:ff0c\:8981\:505a\:3002 *)
					];
...
(*Print["the only term of ",GFind,"  ",curreom];*)
			...
			curreom=grasp[lhs,recent,curreom ];   (* \:8fd8\:6ca1\:505a\:4e0b\:6807\:4ee3\:6362\:ff0c\:8981\:505a\:3002 *)
			(*Print["grasped into ",curreom];*)
			gfidx=GFIiT[curreom ];
			gfform=GFiT[curreom ];
			If[Length[gfform]>1,Print["Error: multiple of GF's found in term ",curreom  ];Abort[]; ];
			If[gfidx>0,
				If[CCinTerm[curreom],
					If[!MemberQ[pathway,gfidx],
						curreom=curreom/MiT[curreom ]/GFiT[curreom ]*kaca[gfidx,pathway~Join~{GFind},MiT[curreom ] ,
						GFTOsubsub[GFnames[[gfidx]],gfform]  ];
					,
						TS=Union[TS,{gfidx}];
					]
			...
			If[Head[curreom]===Plus,
				...
				For[j=1,j<=Length[curreom ],j++,
					...
					curreom[[j]]=grasp[lhs,recent,curreom[[j]] ];   (* \:8fd8\:6ca1\:505a\:4e0b\:6807\:4ee3\:6362\:ff0c\:8981\:505a\:3002 *)
				];
				curreom=Plus@@curreom;
			,
	...
	If[MemberQ[TS,GFind],
		(* \:5305\:542b\:81ea\:5df1\:7684\:8bdd\:9700\:8981\:5148\:89e3\:4e86\:5b83 *)
(*	Print["**",GFind," ",multiplier," ",GFnames[[GFind]]/.replist," \n  ",curreom,"  ",pathway,"  ",TS];*)
		curreom=solveself[lhs,curreom];
	];
(*	Print["   kaca : ",GFind," ends with: ",lhs," == ",curreom//ExpandAll,"  ",pathway,"    "]; *)
	curreom//ExpandAll
]
solveself[lhs_,rhs_Plus]:=Module[{redo=1,i,fm,trhs=rhs,oneminus=0,rec={},u,poly,cd,left,ret=0,ab=0,fm2},
	While[redo==1,
		...
		For[i=1,i<=Length[trhs],i++,
			If[!FreeQ[trhs[[i]],fm],
				oneminus+=trhs[[i]]/lhs;
	(*If[!FreeQ[oneminus,Power],Print["bu de liao le!!!!\n",lhs," == ",rhs,"\n",trhs];Abort[];];*)
				trhs[[i]]=0;
			,	
...
(*					trhs[[i]]=kaca[GFIiT[fm],{},trhs[[i]]/GFiT[trhs[[i]] ],GFTOsubsub[GFnames[[GFIiT[fm] ]],fm] ];*)
					trhs[[i]]=ExpandAll[diedaiTOsky[trhs[[i]],{GFIiT[trhs[[i]] ] } ]  ];
		...
		If[!FreeQ[trhs,Power[_,-1] ], Print["internal error: shouldn't have division ",trhs]; ];
		trhs=Plus@@trhs;
	];
	...
	If[Head[trhs]=!=Plus,
		...
		fm2=GammaEnergySymbol[lhs,cd,1-oneminus]*left;
			If[Length[GammaEnergy]==62, Print["ge 1 ",lhs,"  ",cd,"  ",oneminus]; ];
		ret=grasp[1,fm2,fm2];
	,
		equaltime=Select[trhs,GFIiT[#]==0&];
		For[i=1,i<=Length[trhs],i++,
			AppendTo[rec,{GFIiT[trhs[[i]]],CCprofile[trhs[[i]] ] , GFiT[trhs[[i]] ]  } ]
		];
		u=Union[  rec[[All,1]]  ];

		For[i=1,i<=Length[u],i++,
			If[u[[i]]!=0 && Length[    Union[ Select[rec,#[[1]]==u[[i]]& ]  [[All,2]]   ]    ] != 1,
				Print["internal error: uneven CC in self-consistent solution of eq. ",lhs," == ",trhs " == ",rhs];
				Print[rec];
				Print[u];
				Print[u[[i]] ];
				ab=1;
	...
	*)
	...
	(*Print[i," ______ ",poly];*)
		...
		(*Print[poly];*)
				...
				left=cd;
		(*Print[cd];*)
				cd=Plus@@(poly/cd);  (* this is the numeritor that is to be defined within new SE *)
			...
			fm2=GammaEnergySymbol[lhs,cd,1-oneminus]*left;
(*			If[Length[GammaEnergy]==62, Print["ge 2 ",lhs,"  ",cd,"  ",oneminus, " ",fm2]; ];*)
			ret+=grasp[1,fm2,fm2];
		...
		If[equaltime=!=0 ,   (* to be deleted if we aren't using the original 'devrim' setup *)
			If[Head[equaltime]===Plus,
				For[i=1,i<=Length[equaltime],i++,
					...
					left=equaltime[[i]]/cd;
					fm2=GammaEnergySymbol[lhs,cd,1-oneminus]*left;
			If[Length[GammaEnergy]==62, Print["ge 3 ",equaltime,"  ",fm2]; ];
					ret+=grasp[1,fm2,fm2];
				]
			,
				...
				left=equaltime/cd;
				fm2=GammaEnergySymbol[lhs,cd,1-oneminus]*left;
			If[Length[GammaEnergy]==62, Print["ge 4 ",equaltime,"  ",fm2]; ];
				ret+=grasp[1,fm2,fm2];
			];
...
gas[]:=jietu[]
jietu[]:=Module[{sym,symbol,out,left,coef,coef2,dest,dest2,currsol,unknown={1},done={},solgraph={},idx,i,j}, 
...
Print["coef: ",coef];
	...
	Print["dest2: ",dest2];
	If[dest2==0,Print["this shouldn't happen...."];Abort[];];
...
jiantu[]:=Module[{idx,pos,i,j,expr,gf,coef,outgo,val},  (* by default start with 1st gf *)
...
tedian[expr_]:=Module[{ret=3},  (* xi shu *)
...
GFxingshi[expr_Plus]:=Sum[GFxingshi[expr[[i]]],{i,Length[expr]}]
GFxingshi[expr_Times]:=Product[GFxingshi[expr[[i]]],{i,Length[expr]}]
GFxingshi[expr_NonCommutativeMultiply]:=Module[{ret=expr,pos},
	If[Length[expr]==2,
...
jie[idx_Integer]:=Module[{sol,s2,ct},
	If[nonSubed[GFnames[[idx]]],
		...
		If[MemberQ[ct ,idx] || exceed[ct,idx],
			Print["Sorry: solution of GF #",idx," contained itself or later GF's. jie[",idx,"] failed."];
			Abort[]
		,
			solgf[[idx,3]]=sol
		];
...
fhdaijie[idx_Integer]:=Module[{sol,ct,cta},
		sol=solgf[[idx,3]];
		ct=subbed[containedGF[sol]];
		Print[idx, "   ",ct];
		While[Length[thre[ct,idx] ]>0,
			sol=diedaiTOsky[sol,thre[ct,idx]]; (* here we change it into larger than idx'ed ct *)
			sol=Simplify[sol,ComplexityFunction->NRcontainedGF,TimeConstraint->10];
			cta=containedGF[sol];
			ct=subbed[cta];
			Print[idx, "  die le  ",cta, " ge shu: ",NRcontainedGF[sol]," zhong shu: ",Length[cta] ];
		];
		...
		If[MemberQ[containedGF[sol ] ,idx],
			Print["Sorry: solution of GF #",idx," contained itself. fhdaijie[",idx,"] failed."];
			Abort[]
		,
			solgf[[idx,3]]=sol
		];
...
fen[]:=Module[{k,i,s},
	...
	For[k=1,k<=Min[cap,Length[gfs]],k++,
		For[i=1,i<=Length[trunclist],i++,
			s=Sum[Count[gfs[[k,1]]**gfs[[k,2]],trunclist[[i,1,j]],Infinity   ],{j,Length[trunclist[[i,1]]]}];
...
fenjie[verbo_:0,yaoqiu_,idx_Integer,cat_Integer,geshu_Integer]:=Module[{sol,ct,cta,ret=True,s2,nr},
	Print[" num: ",idx," cat: ",cat," geshu: ",geshu];
	sol=solgf[[idx,3]];
	If[verbo>0,Print["getting GF index ..."];];
	ct=containedGF[sol];
	...
	If[verbo>0,Print["finally ", idx," contains ",ct," ge shu: ",NRcontainedGF[s2]  ];];
	If[MemberQ[ct ,idx],
		Print["Sorry: solution of GF #",idx," contained itself. fenjie[",idx,",",cat,",",geshu,"] failed."];
		solgf[[idx,3]]=sol;  (* this is true, it only contains itself, eliminate it next time. *)
		ret=False;
	,
		solgf[[idx,3]]=s2;
...
sljie[idx_Integer]:=Module[{sol,ct,cta},
		sol=solgf[[idx,3]];
		ct=subbed[containedGF[sol]];
		Print[idx, "   ",ct];
		While[Length[ct]>0,
		...
		Print["finally ", idx," contains ",ct  ];
		If[MemberQ[ct ,idx],
			Print["Sorry: solution of GF #",idx," contained itself. sljie[",idx,"] failed."];
			Abort[]
		,
			solgf[[idx,3]]=sol
		];
...
danjie[lv_Integer:3,res_:False]:=Module[{i,uu,tt}, (* lv: 3-fhdaijie+sljie+jie, 2-sljie+jie, 1-jie *)
	uu=TimeUsed[];
	tt=uu;
	If[lv>2,
		Print["Pass 1:"];
...
diedaiTOsky[expr_OverBar,curr_List]:=Module[{pos,i,ret=expr,tok,idx},
		tok=expr;
		Print["tick"];
...
diedaiTO[expr_Plus,curr_Integer]:=Sum[diedaiTO[expr[[i]],curr],{i,Length[expr]}] (*/.selfenergyrep*)
diedaiTO[expr_Times,curr_Integer]:=Expand[ (Product[diedaiTO[expr[[i]],curr],{i,Length[expr]}] ) ]
diedaiTO[expr_OverBar,curr_Integer]:=Module[{pos},
	(* this is a GF *)
	pos=Flatten[Position[GFnames,purepattern[expr],1]];
	If[Length[pos]!=0,
		If[Length[pos]>1,
...
diedai[expr_]:=expr
diedai[expr_Times]:=Module[{pl,i,tmp,h,gf,subl,pos},
	h=Head[expr];
	tmp=List@@expr;
...
ResetGFlist[] := Module[{}, gfs = {}; solgf = {}; GFnames={}; ]
ResDisp[]:=Module[{}, 
	Print["************* Equation(s) of motion: *************"];
	TableForm[Table[{i,":  <<",Sequence@@gfs[[i]],">> =",solgf[[i,3]]},{i,Length[gfs] }]]//Print;
	Print[];
	Print["************* Isolated Green's Function(s): *************"];
	TableForm[Table[{IGFs[[i,2]]," \[Congruent] ",IGFs[[i,1]]},{i,Length[IGFs]}] ]//Print;
	If[SelfEnergy=!={}, 
		Print["************ Self-Energy(ies): ************ "]; 
		TableForm[Table[{SelfEnergy[[i,2]]," \[Congruent] ",SelfEnergy[[i,1]]},{i,Length[SelfEnergy]}]]//Print;
	];
	If[GammaEnergy=!={},
		TableForm[Table[{GammaEnergy[[i,2]]," \[Congruent] ",GammaEnergy[[i,1]]},{i,Length[GammaEnergy]}]
			...
			If[!FreeQ[IGFs[[i,1]],IGFs[[j,1]]],
				If[Depth[IGFs[[i,2]] ]==2,
					AppendTo[selfenergyrep,
						UnderBar[(IGFs[[i,2]]/.IGFs[[i,2,1]]-> IGFs[[j,2,1]])]*Product[IGFs[[j,3,m]],
						{m,Length[IGFs[[j,3]]]}] -> Unique["\[CapitalSigma]"]  ];
				,
					AppendTo[selfenergyrep,
						UnderBar[IGFs[[i,2]]]*Product[IGFs[[j,3,m]],
						{m,Length[IGFs[[j,3]]]}]->Unique["\[CapitalSigma]"]  ];
				];
				Break[];
			];
...
annihilation[op_OverHat] := Module[{i, ret = False}, 
	For[i = 1, i <= Length[rulelist], i++, 
		If[MatchQ[op[[1]], rulelist[[i,1]]] == True, ret = True]
	]; 
	ret
]
creation[op_OverHat] := Module[{i, ret = False}, 
	For[i = 1, i <= Length[rulelist], i++, 
		If[MatchQ[op[[1]], rulelist[[i,2]]] == True, ret = True ]
	]; 
	ret
]
ZhaoGF[expr_] := Module[{}, ResetGFlist[]; zhaogf[expr]; 
	Print["Target Green's function set as: ",gfs[[1]] ]; 
]
TargetGF[expr_]:=ZhaoGF[expr]
zhaogf[expr_Plus] := Sum[zhaogf[expr[[i]]], {i, Length[expr]}]
zhaogf[expr_Times] := Sum[zhaogf[expr[[i]]], {i, Length[expr]}]
zhaogf[expr_NonCommutativeMultiply] := Module[{k = 0}, 
...
zhaogf[expr_] := 0
preserveQ[op_OverHat] := Module[{i, ret = False}, 
	For[i = 1, i <= Length[preservelist], i++, 
		If[MatchQ[op, preservelist[[i]]], ret = True]
	]; 
	ret
]
preserveQ[e_]:=False
FengZhuang[expr_]:=Module[{ret},
	If[expr===0, Print["Error: fengzhuang called with zero argument."]; Abort[] ];
	ret=fenzhuang[expr];
	If[Head[ret[[1]]] =!= List, ret={ret}];
	ret
]
fenzhuang[expr_Plus]:=Module[{c={},i,j},
	For[i=1,i<=Length[expr],i++,
		AppendTo[c,fenzhuang[expr[[i]]]]
	]; 
	c
]
fenzhuang[expr_Times]:=Module[{kk=expr,re={}},
	If[FreeQ[expr,NonCommutativeMultiply]==False,
	(*\:91cc\:9762\:6709\:7b97\:7b26\:79ef*)
		For[i=1,i<=Length[expr],i++,
	...
	,  (* else *)
	(*\:91cc\:9762\:6ca1\:6709\:7b97\:7b26\:79ef\:ff0c\:4f46\:6709\:7b97\:7b26*)
...
DeriveGF[Hamiltonian_] := Module[{tim,kk,GFlistIndex = 1, rhs, dt, deltatimes,trid},
	...
	While[GFlistIndex <= Length[gfs],
		(* Print[GFlistIndex,":  ",gfs[[GFlistIndex]] ]; *)
		...
		If[ twoidentical[ gfs[[GFlistIndex,dt]] ],
			...
			GFlistIndex++;
			(* Print["set to zero by fermi rule."]; *)
			Continue[]    (* i'm hoping this one will go on with the next "while" *)
		];


		trid=yao[gfs[[GFlistIndex,dt]]];  (* the part been done is longer *)
		If[trid==0,
			If[dt==1,
				rhs = FengZhuang[Grab[ExpandAll[com[gfs[[GFlistIndex,1]], Hamiltonian]] //. 
					{(a_)**((b_) + (c_)) :> a**b + a**c, ((a_) + (b_))**(c_) :> a**c + b**c,
						(a_ b_)**c_:>a**b**c, a_**(b_ c_):>a**b**c}     ]]
			,
				rhs = FengZhuang[Grab[-ExpandAll[com[gfs[[GFlistIndex,2]], Hamiltonian]] //.  
					{(a_)**((b_) + (c_)) :> a**b + a**c, ((a_) + (b_))**(c_) :> a**c + b**c,
						(a_ b_)**c_:>a**b**c, a_**(b_ c_):>a**b**c}	]]
			]; 
		...
		,
			...
			(* Print["max length reached, truncate ",trid]; *)
			If[rhs =!= 0,	rhs=FengZhuang[paixu[rhs] ]  ];
	...
	M=Table[Ling,{Length[SuoEOM]},{Length[SuoEOM]+1 }  ];
	L=Range[3];
	Print[Length[gfs]," equation(s) finished in ",TimeUsed[]-tim," second(s)."];
]
twoidentical[expr_NonCommutativeMultiply]:=Module[{ret=False,i},
	For[i=1,i<Length[expr],i++,
		If[expr[[i]]===expr[[i+1]],
			ret=True;
			Break[]
...
yidong[expr_Plus,dt_]:=Sum[yidong[expr[[i]],dt ],{i,Length[expr]}]
yidong[expr_Times,dt_]:=Product[yidong[expr[[i]],dt],{i,Length[expr]}]
yidong[expr_NonCommutativeMultiply,1]:=Module[{yid,nage,ret,l1,l2,pos},
	ret="Undefined";
	yid=yao[expr];
	If[yid!=0,
	...
	If[ret==="Undefined",Print["Error: returning value of yidong not defined."];Abort[]];
	ret
]
yidong[expr_NonCommutativeMultiply,2]:=Module[{yid,nage,ret,l1,l2,pos},
	ret="Undefined";
	yid=yao[expr];
	If[yid!=0,
		{nage,l1,l2}=yaonage[expr,yid];
...
inpos1[len_Integer,l_List,dt_Integer]:=Module[{ret=False},
	If[Length[l]==0, Print["Error: inpos1 called with zero length position list."]; Abort[] ];
	If[dt==1 && l[[1]] == 1, ret= True];
	If[dt==2 && l[[-1]]== len-1, ret=True];
	ret
]
inpos2[len_Integer,l_List,dt_Integer]:=Module[{ret=False},
	If[Length[l]==0, Print["Error: inpos2 called with zero length position list."]; Abort[] ];
	If[dt==1 && l[[1]] == 2, ret= True];
	If[dt==2 && l[[-1]]== len, ret=True];
	ret
]
fermiyi[expr_NonCommutativeMultiply,pos_Integer,dt_Integer]:=Module[{tmp=expr},
	If[dt==1, (* move pos left *)
		If[pos<2, Print["Error: illegal value in fermiyi[",expr,",",pos,",",dt,"]"];Abort[] ];
		tmp[[pos-1]]=com[tmp[[pos-1]],tmp[[pos]]]-tmp[[pos]]**tmp[[pos-1]];
		tmp[[pos]]=1
	];
	If[dt==2, (* move pos right *)
		If[pos>Length[expr]-1,Print["Error: illegal value in fermiyi[",expr,",",pos,",",dt,"]"];Abort[] ];
		tmp[[pos]]=com[tmp[[pos]],tmp[[pos+1]]]-tmp[[pos+1]]**tmp[[pos]];
		tmp[[pos+1]]=1
	];
...
clearup[expr_NonCommutativeMultiply]:=Module[{i,tmp,mtpl=1,ret=expr,pos,p2,p1},
	...
	(* \:6211\:4eec\:4e4b\:6240\:4ee5\:80fd\:8fd9\:4e48\:505a\:662f\:56e0\:4e3aXX\:603b\:662f\:6392\:5728XXdag\:524d\:9762 *)
	p2=ret[[-1]];
	If[Length[ret]>2, p1=ret[[1;;-2]] ];
	If[Length[ret]==2,p1=ret[[1]] ];
	If[Length[ret]<2, Print["Error: can't clearup a too short expression:",ret]; Abort[] ];
...
corr[a_OverHat,b_OverHat]:=Module[{},
	If[Length[a[[1]]]!=Length[b[[1]]] || !MatchQ[a,purepattern[b]],
		Print["Error: parameters ",a," and ",b," in corr should be identical in form."];
		Abort[]
	];
	If[Depth[a]==3,
...
yao[expr_]:=Module[{i,ret=0},
	For[i=1,i<=Length[trunclist],i++,
		(* for the moment, length is assumed to be 2 later on *)
		If[Sum[Count[expr,trunclist[[i,1,j]]],{j,Length[trunclist[[i,1]]]}] > trunclist[[i,2]] ,
			ret=i;
			Break[]
		]
	];
...
yaonage[expr_,yid_]:=Module[{l1={},l2={},ret=0},
	For[i=1,i<=Length[trunclist[[yid,3]]],i++,
		...
		If[Length[l1]>0 && Length[l2]>0, ret=i; Break[] ]
	];
